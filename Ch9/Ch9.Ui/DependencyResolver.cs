...
namespace Ch9.Ui
{
    ...
    internal static class DependencyResolver
    {
        ...
        public static void ConfigureServices(HttpClient httpClient, IDictionary<string, object> settingsKvps)
        {
            ...
            builder.RegisterType<TrendingMoviesService>().As<ITrendingMoviesService>().SingleInstance();
            ...
            builder.RegisterType<RatingService>().As<IRatingService>().SingleInstance();
